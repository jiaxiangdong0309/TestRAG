...
export const ENV_CONFIG = {
    ...
    development: {
        ...
        DIFY_BROWSER_API_BASE_URL: LOCAL_CONFIG.DIFY_BROWSER_API_BASE_URL,
        DIFY_BROWSER_API_KEY: LOCAL_CONFIG.DIFY_BROWSER_API_KEY,
...
export const ENV_VARS = {
    ...
    VITE_DIFY_BROWSER_API_BASE_URL: import.meta.env.VITE_DIFY_BROWSER_API_BASE_URL,
    VITE_DIFY_BROWSER_API_KEY: import.meta.env.VITE_DIFY_BROWSER_API_KEY,
} as const